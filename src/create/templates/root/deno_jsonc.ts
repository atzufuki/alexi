...
export function generateDenoJsonc(name: string): string {
  const config = {
    ...
    imports: {
      // Alexi framework
      "@alexi/core": "jsr:@alexi/core@^0.16",
      "@alexi/db": "jsr:@alexi/db@^0.16",
      "@alexi/db/backends/denokv": "jsr:@alexi/db@^0.16/backends/denokv",
      "@alexi/db/backends/indexeddb": "jsr:@alexi/db@^0.16/backends/indexeddb",
      "@alexi/db/backends/rest": "jsr:@alexi/db@^0.16/backends/rest",
      "@alexi/urls": "jsr:@alexi/urls@^0.16",
      "@alexi/http": "jsr:@alexi/http@^0.16",
      "@alexi/middleware": "jsr:@alexi/middleware@^0.16",
      "@alexi/views": "jsr:@alexi/views@^0.16",
      "@alexi/web": "jsr:@alexi/web@^0.16",
      "@alexi/webui": "jsr:@alexi/webui@^0.16",
      "@alexi/staticfiles": "jsr:@alexi/staticfiles@^0.16",
      "@alexi/restframework": "jsr:@alexi/restframework@^0.16",
      "@alexi/auth": "jsr:@alexi/auth@^0.16",
      "@alexi/admin": "jsr:@alexi/admin@^0.16",
